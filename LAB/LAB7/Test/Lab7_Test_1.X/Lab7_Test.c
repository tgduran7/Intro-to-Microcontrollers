...
#define NS_PED PORTAbits.RA3
#define NS_LT PORTAbits.RA1

#define EW_PED PORTAbits.RA4
#define EW_LT PORTAbits.RA2

#define SEG_G PORTEbits.RE0
#define MODE_LED PORTBbits.RB7

#define NSLT_SW PORTAbits.RA0
...
void Day_Mode()
{
    ...
    Wait_N_Seconds(3);  //
    Set_NS(RED);    // Step 4
    if(EWLT_SW == 1)    // Step 5                                                       //Step5ab
    {
        Set_EWLT(GREEN);    // Step 6                                                       //Step6
        Wait_N_Seconds(6);  //                                                      //Step6
        
        Set_EWLT(YELLOW);   // Step 7                                                       //Step7
        Wait_N_Seconds(3);  //                                                      //Step7
        
        Set_EWLT(RED);      // Step 8                                                          //Step8
    }
    
    Set_EW(GREEN);      // Step 9                                                              //Step9
    if(EWPED_SW == 1)   //                                                           //Step9ab
    {
        PED_Control(1,9);   // Step 9 Part A
    }
    
    Set_EW(GREEN);      // Step 10
    Wait_N_Seconds(7);  //                                                         //Step10
...
void Set_NSLT(char color)
{
    switch(color)
    {
        case OFF: NSLT_RED =0; NS_GREEN=0; break;
        case RED: NSLT_RED =1; NS_GREEN=0; break;
        case GREEN: NSLT_RED =0; NS_GREEN=1; break;
        case YELLOW: NSLT_RED =1; NS_GREEN=1; break;
    }
}
...
void Set_EW(char color)
{
    switch(color)
    {
        case OFF: EW_RED =0; NS_GREEN=0; break;
        case RED: EW_RED =1; NS_GREEN=0; break;
        case GREEN: EW_RED =0; NS_GREEN=1; break;
        case YELLOW: EW_RED =1; NS_GREEN=1; break;
    }
}
...
void Set_EWLT(char color)
{
    switch(color)
    {
        case OFF: EWLT_RED =0; NS_GREEN=0; break;
        case RED: EWLT_RED =1; NS_GREEN=0; break;
        case GREEN: EWLT_RED =0; NS_GREEN=1; break;
        case YELLOW: EWLT_RED =1; NS_GREEN=1; break;
    }
}
