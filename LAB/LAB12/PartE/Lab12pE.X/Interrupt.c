...
{    
    ...
    switch(Nec_state)                       // Case statement for Nec state
    {
        case 0 :
        {
                                            // Clear Timer 1
        ...
        case 1 :
        {
            ...
            {
                Nec_state = 2;              // Set Nec State to 1
                INTCON2bits.INTEDG0 = 0;    // Change edge interrupt
            }
            return;
        }
        ...
        case 2 :                            // Add your code here
        {
            ...
            {
                Nec_state = 3;              // Set Nec State to 3
                INTCON2bits.INTEDG0 = 1;    // Change edge interrupt
            }
            return;
        }
        ...
        case 3 :                            // Add your code here
        {
            ...
            {
                Nec_state = 4;              // Set Nec State to 3
                INTCON2bits.INTEDG0 = 0;    // Change edge interrupt
            }
            return;
        }
        ...
        case 4 :                            // Add your code here
        {
            ...
            {
                Nec_code = Nec_code << 1;     // Shift Nec_code left 1 bit
                ...
                if(bit_count > 31)
                {
                    ...
                    INTCONbits.INT0IE = 0;      // set interrupt flag to 0
                    Nec_state = 0;
                }
