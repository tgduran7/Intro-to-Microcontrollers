...
void PED_Control(char, char); //void PED_Control( char Direction, char Num_Sec);
void Day_Mode(void);
...
void update_LCD_PED_Count(char, char); //void update_LCD_PED_Count(char direction, char count);
...
void Day_Mode()
{
    ...
    if(EW_PED_SW == 1)   //                                                           
    {
        PED_Control(2,10);   // Step 9 Part A
    }
    ...
    if(NS_LT_SW == 1)    // Step 13                                                            //Step13ab
    {
        Set_NS_LT(GREEN);    // Step 14                                                        //Step14
        Wait_N_Seconds(6);  //                                                      //Step14
        
        Set_NS_LT(YELLOW);   // Step 15                                                       //Step15
        Wait_N_Seconds(3);  //                                                       //Step15
        
        Set_NS_LT(RED);      // Step 17                                                          //Step16
    }        
}
void Night_Mode()
{ 
