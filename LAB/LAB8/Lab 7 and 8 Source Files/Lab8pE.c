...
#define NS_RED PORTAbits.RA5                                                                // Location of the RED Pin for the NS LED
#define NS_GREEN PORTBbits.RB0                                                              // Location of the GREEN Pin for the NS LED

#define NSLT_RED PORTBbits.RB1                                                              // Location of the RED Pin for the NSLT LED
#define NSLT_GREEN PORTBbits.RB2                                                            // Location of the GREEN Pin for the NSLT LED
...
#define NS_LT_SW PORTAbits.RA1                                                              // Location of the NSLT SW
#define NS_PED_SW PORTAbits.RA3                                                             // Location of the NSPED SW

#define EW_PED_SW PORTAbits.RA4                                                             // Location of the EWPED SW
...
void main(void)
{
    init_IO();                                                                              // Initialize the IO PORTS
    Init_ADC();                                                                             // Initialize the ADCON Values
